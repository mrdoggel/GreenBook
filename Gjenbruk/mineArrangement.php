<?php
//koble til databasen
        echo "<h2>"._YOUREVENTS."</h2>";
         require 'Kobling/kob.php';
         //Hent ut alle arrangementer med villkår i SQL spørring, alle med pnr lik din egen i dette tilfellet
         $pnr = $_SESSION['id'];
         $sql = $conn->prepare("SELECT * FROM arrangement WHERE Pnr = ? AND Ferdig = 0");
