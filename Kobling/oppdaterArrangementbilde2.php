            ...
            if ($filError === 0) {
                if ($filStrl < 1000000) {
                    ...
                    if ($sql->execute() === TRUE) {
                        ...
                        header("location: ../Arrangement.php?arrangement=$anr&error=$conn->error");
                    }
                    
                } else {
                    header("location: ../Arrangement.php?arrangement=$anr&error=Filen_din_er_for_stor");
                }
            } else {
                header("location: ../Arrangement.php?arrangement=$anr&error=Et_problem_oppstod");
            }
        } else {
            header("location: ../Arrangement.php?arrangement=$anr&error=Feil_filtype");
        }
    }
